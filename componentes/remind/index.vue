		...
		<uni-badge class="remind_badge" :text="value" absolute="rightTop" size="small">
			<view class="box">
				<svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<path d="M10 38V18C10 10.268 16.268 4 24 4C31.732 4 38 10.268 38 18V38M4 38H44" stroke="#333"
						stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
					<path d="M24 44C26.7614 44 29 41.7614 29 39V38H19V39C19 41.7614 21.2386 44 24 44Z" fill="none"
